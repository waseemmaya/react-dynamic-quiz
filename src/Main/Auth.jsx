    ...
    fire
      ...
      .then(a => {
        ...
        userRef.on("value", x => {
          ...
          localStorage.setItem("myName", uffName);
          swal(`Good job ${uffName}!`, "Login Successfully!", "success").then(
            val => {
              this.props.afterLogin(uffName);
            }
          );
        });
      })
  ...
  handleSignup = e => {
    ...
    fire
      ...
      .then(data => {
        ...
        localStorage.setItem("myID", data.user.uid);

        swal(`Good job ${name}!`, "Signup Successfully!", "success");
        this.setState({
          showNum: 1
        });
      })
